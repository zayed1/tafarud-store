          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-dark-light hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg transition-colors cursor-pointer"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-dark-light hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg transition-colors cursor-pointer"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-dark-light hover:text-sky-500 hover:bg-sky-50 dark:hover:bg-sky-950/30 rounded-lg transition-colors cursor-pointer"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={shareEmail}
                className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-dark-light hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-950/30 rounded-lg transition-colors cursor-pointer"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
