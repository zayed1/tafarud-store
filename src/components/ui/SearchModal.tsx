...
export default function SearchModal({ isOpen, onClose }: SearchModalProps) {
  ...
  const groupedResults = results.reduce<Record<string, Product[]>>((acc, product) => {
                ...
                <div className="p-2">
                  {Object.entries(groupedResults).map(([categoryName, categoryProducts]) => (
                    <div key={categoryName}>
                      <p className="text-xs font-medium text-muted uppercase tracking-wider px-3 pt-3 pb-1">
                        {categoryName}
                      </p>
